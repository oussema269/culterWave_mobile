    ...
    public static ServicePanier getInstance() {
     ...
     public boolean addpanier(panier panier,int id_produit) {
      ...
      //String description=t.getDescription();
         ...
         String url =DB.BASE_URL+"/addcart?idClient="+panier.getId_user()+"&idProduct="+id_produit+"&qt="+1;
...
//          String url = Statics.BASE_URL+"/mobile/listReclamtion/";
          String url =DB.BASE_URL+"/affqt?id="+id+"&idprod="+idprod;
          req.setUrl(url);
          req.setPost(false);
          req.addRequestHeader("accept", "application/json");
          req.addResponseListener(new ActionListener<NetworkEvent>() {
...
//            System.out.println(response);
     ...
     public boolean deletepanier(int id) {
       ...
       public boolean increment(int id,int idprod) {
        System.out.println("********");
        //String url = Statics.BASE_URL + "create?name=" + t.getName() + "&status=" + t.getStatus();
       String url =DB.BASE_URL+"/increment?id="+id+"&idprod="+idprod;
        req.setUrl(url);
        req.setPost(false);
        System.out.println(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
        ...
        System.out.println("********");
        //String url = Statics.BASE_URL + "create?name=" + t.getName() + "&status=" + t.getStatus();
       String url =DB.BASE_URL+"/decrement?id="+id+"&idprod="+idprod;
        req.setUrl(url);
        req.setPost(false);
        System.out.println(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
