...
public class AjouterFormationForm extends BaseForm{
      ...
      public AjouterFormationForm(Resources res) {
        ...
        RadioButton ajoutformation = RadioButton.createToggle("Ajouter Formation", barGroup);
        ...
        RadioButton graphique= RadioButton.createToggle("Graphique", barGroup);
        graphique.setUIID("SelectBar");
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, ajoutformation, formation, graphique),
                FlowLayout.encloseBottom(arrow)
        ));


            graphique.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(graphique, arrow);
        });
        ...
        formation.addActionListener((e)->{
         ...
         bindButtonSelection(graphique, arrow);
