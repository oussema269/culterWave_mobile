...
import com.culturewave.reclamation.entities.user;
import com.culturewave.rayen.services.ServiceProduit;
import com.culturewave.rayen.services.ServiceUser;
import com.culturewave.rayen.services.ServicePanier;
...
panier.addActionListener(e -> {
   ...
   private void addButton(Image img, produit produit, Resources res) {
    ...
    Label nomTxt = new Label("produit : " + produit.getLib(), "NewsTopLine2");
    Label prixTxt = new Label("Prix : " + produit.getPrix() + "DT", "NewsTopLine2");
    ...
    lSupprimer.addPointerPressedListener(l -> {
        ...
        // Supprimer le produit via le service Produit
        if(ServiceProduit.getInstance().deleteProduit(produit.getId())) {
    ...
    lModifier.addPointerPressedListener(l -> {
        new ModifierProduitForm(res, produit).show();
    });
